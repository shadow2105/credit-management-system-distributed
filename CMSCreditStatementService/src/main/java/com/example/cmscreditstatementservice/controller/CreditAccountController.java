...
public class CreditAccountController {
    ...
    // - GET - /api/v1/customer/{customer-id}/credit-statements/credit-accounts ( view all accounts )
    @GetMapping(value = "/{customer-id}/credit-statements/credit-accounts", produces = {"application/json"})
